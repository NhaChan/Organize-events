...
<section class="section-card settings-card">
    ...
    <form method="post" action="{{ route('admin.settings.save') }}" data-confirm="Xác nhận cập nhật thông tin công khai trên website?" data-confirm-title="Cập nhật website">
        ...
        <div class="form-group"><label class="form-label">Trang Zalo</label><input type="url" class="form-control-custom" name="zalo" value="{{ old('zalo', $settings['zalo'] ?? '') }}" placeholder="https://zalo.me/0777760812"><small class="form-help">Để trống sẽ tự mở Zalo theo số điện thoại phía trên.</small></div>
