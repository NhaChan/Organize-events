...
<head>
    ...
    <link rel="icon" type="image/png" sizes="256x256" href="{{ \App\Support\SeoUrl::asset("images/nina-nina-icon.png") }}">
    <link rel="apple-touch-icon" href="{{ \App\Support\SeoUrl::asset("images/nina-nina-icon.png") }}">
